                    ...
                    <div class="haircut-image">
                        ...
                        <div class="haircut-overlay">
                            <div class="overlay-actions">
                                <button class="overlay-btn save-btn <?php echo $haircut['is_saved'] > 0 ? 'saved' : ''; ?>" onclick="toggleSave(<?php echo $haircut['id']; ?>, this)" title="<?php echo $haircut['is_saved'] > 0 ? 'Remove from Saved' : 'Save Style'; ?>">
                                    <i class="<?php echo $haircut['is_saved'] > 0 ? 'fas' : 'far'; ?> fa-heart"></i>
                                </button>
